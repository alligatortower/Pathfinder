...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_equipment', (
            ...
            ('is_equiped', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_a', self.gf('django.db.models.fields.CharField')(default='Weapon', max_length=10)),
            ('cost', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('weight', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('comments', self.gf('django.db.models.fields.CharField')(default='---', max_length=500)),
        ))
        db.send_create_signal(u'main', ['Equipment'])

        # Adding model 'Weapon'
        db.create_table(u'main_weapon', (
            (u'equipment_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['main.Equipment'], unique=True, primary_key=True)),
            ('attack_bonus', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('special', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('damage', self.gf('django.db.models.fields.CharField')(default='1d3', max_length=10)),
            ('damage_type', self.gf('django.db.models.fields.CharField')(default='S', max_length=10)),
            ('crit_muliplier', self.gf('django.db.models.fields.CharField')(default='x2', max_length=3)),
            ('crit_range', self.gf('django.db.models.fields.CharField')(max_length=3, null=True)),
        ))
        db.send_create_signal(u'main', ['Weapon'])

        # Adding model 'Armor'
        db.create_table(u'main_armor', (
            (u'equipment_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['main.Equipment'], unique=True, primary_key=True)),
            ('ac_bonus', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('max_dex', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True)),
            ('armor_check_penalty', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('spell_fail_chance', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('speed_if_base_20', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('speed_if_base_30', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'main', ['Armor'])


    def backwards(self, orm):
        # Deleting model 'Equipment'
        db.delete_table(u'main_equipment')

        # Deleting model 'Weapon'
        db.delete_table(u'main_weapon')

        # Deleting model 'Armor'
        db.delete_table(u'main_armor')
    ...
    models = {
        ...
        u'main.equipment': {
            ...
            'comments': ('django.db.models.fields.CharField', [], {'default': "'---'", 'max_length': '500'}),
