...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'main_character', 'ac')

        # Adding field 'Character.ac_total'
        db.add_column(u'main_character', 'ac_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ac_dodge'
        db.add_column(u'main_character', 'ac_dodge',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ac_deflection'
        db.add_column(u'main_character', 'ac_deflection',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.combat_maneuver_defense'
        db.add_column(u'main_character', 'combat_maneuver_defense',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.combat_maneuver_defense_misc'
        db.add_column(u'main_character', 'combat_maneuver_defense_misc',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'main_character', 'ac',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Character.ac_total'
        db.delete_column(u'main_character', 'ac_total')

        # Deleting field 'Character.ac_dodge'
        db.delete_column(u'main_character', 'ac_dodge')

        # Deleting field 'Character.ac_deflection'
        db.delete_column(u'main_character', 'ac_deflection')

        # Deleting field 'Character.combat_maneuver_defense'
        db.delete_column(u'main_character', 'combat_maneuver_defense')

        # Deleting field 'Character.combat_maneuver_defense_misc'
        db.delete_column(u'main_character', 'combat_maneuver_defense_misc')
