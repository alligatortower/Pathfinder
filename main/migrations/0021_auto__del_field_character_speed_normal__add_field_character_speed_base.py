...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Character.speed_base'
        db.add_column(u'main_character', 'speed_base',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Character.speed_base'
        db.delete_column(u'main_character', 'speed_base')
