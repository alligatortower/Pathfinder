...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseClass.class_hit_die'
        db.add_column(u'main_baseclass', 'class_hit_die',
                      self.gf('django.db.models.fields.CharField')(default='1d6', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseClass.class_hit_die'
        db.delete_column(u'main_baseclass', 'class_hit_die')
    ...
    models = {
        ...
        u'main.baseclass': {
            ...
            'class_hit_die': ('django.db.models.fields.CharField', [], {'default': "'1d6'", 'max_length': '10'}),
        ...
        u'main.character': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initiative_feat': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
