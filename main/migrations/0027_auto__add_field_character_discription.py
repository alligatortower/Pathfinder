...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.discription'
        db.add_column(u'main_character', 'discription',
                      self.gf('django.db.models.fields.CharField')(default='-', max_length=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.discription'
        db.delete_column(u'main_character', 'discription')
