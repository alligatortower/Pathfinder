...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.melee_attack_bonus_str_or_dex'
        db.add_column(u'main_character', 'melee_attack_bonus_str_or_dex',
                      self.gf('django.db.models.fields.CharField')(default='str', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.melee_attack_bonus_str_or_dex'
        db.delete_column(u'main_character', 'melee_attack_bonus_str_or_dex')
