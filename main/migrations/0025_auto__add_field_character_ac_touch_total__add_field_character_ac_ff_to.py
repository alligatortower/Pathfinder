...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.ac_touch_total'
        db.add_column(u'main_character', 'ac_touch_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ac_ff_total'
        db.add_column(u'main_character', 'ac_ff_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.ac_touch_total'
        db.delete_column(u'main_character', 'ac_touch_total')

        # Deleting field 'Character.ac_ff_total'
        db.delete_column(u'main_character', 'ac_ff_total')
