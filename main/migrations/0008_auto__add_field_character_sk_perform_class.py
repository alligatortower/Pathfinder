...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.sk_perform_class'
        db.add_column(u'main_character', 'sk_perform_class',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.sk_perform_class'
        db.delete_column(u'main_character', 'sk_perform_class')
