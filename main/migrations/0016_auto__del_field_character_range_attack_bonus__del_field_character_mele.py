...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Character.range_attack_bonus'
        db.delete_column(u'main_character', 'range_attack_bonus')

        # Deleting field 'Character.melee_attack_bonus'
        db.delete_column(u'main_character', 'melee_attack_bonus')

        # Adding field 'Character.melee_attack_bonus_1'
        db.add_column(u'main_character', 'melee_attack_bonus_1',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.melee_attack_bonus_2'
        db.add_column(u'main_character', 'melee_attack_bonus_2',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.melee_attack_bonus_3'
        db.add_column(u'main_character', 'melee_attack_bonus_3',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.melee_attack_bonus_4'
        db.add_column(u'main_character', 'melee_attack_bonus_4',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ranged_attack_bonus_1'
        db.add_column(u'main_character', 'ranged_attack_bonus_1',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ranged_attack_bonus_2'
        db.add_column(u'main_character', 'ranged_attack_bonus_2',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ranged_attack_bonus_3'
        db.add_column(u'main_character', 'ranged_attack_bonus_3',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ranged_attack_bonus_4'
        db.add_column(u'main_character', 'ranged_attack_bonus_4',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Character.range_attack_bonus'
        db.add_column(u'main_character', 'range_attack_bonus',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.melee_attack_bonus'
        db.add_column(u'main_character', 'melee_attack_bonus',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Character.melee_attack_bonus_1'
        db.delete_column(u'main_character', 'melee_attack_bonus_1')

        # Deleting field 'Character.melee_attack_bonus_2'
        db.delete_column(u'main_character', 'melee_attack_bonus_2')

        # Deleting field 'Character.melee_attack_bonus_3'
        db.delete_column(u'main_character', 'melee_attack_bonus_3')

        # Deleting field 'Character.melee_attack_bonus_4'
        db.delete_column(u'main_character', 'melee_attack_bonus_4')

        # Deleting field 'Character.ranged_attack_bonus_1'
        db.delete_column(u'main_character', 'ranged_attack_bonus_1')

        # Deleting field 'Character.ranged_attack_bonus_2'
        db.delete_column(u'main_character', 'ranged_attack_bonus_2')

        # Deleting field 'Character.ranged_attack_bonus_3'
        db.delete_column(u'main_character', 'ranged_attack_bonus_3')

        # Deleting field 'Character.ranged_attack_bonus_4'
        db.delete_column(u'main_character', 'ranged_attack_bonus_4')
