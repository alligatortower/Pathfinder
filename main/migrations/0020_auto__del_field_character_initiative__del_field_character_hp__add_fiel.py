...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Character.hp'
        db.delete_column(u'main_character', 'hp')

        # Adding field 'Character.initiative_total'
        db.add_column(u'main_character', 'initiative_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.total_hp'
        db.add_column(u'main_character', 'total_hp',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Character.nonlethal_damage'
        db.add_column(u'main_character', 'nonlethal_damage',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Character.hp'
        db.add_column(u'main_character', 'hp',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'Character.initiative_total'
        db.delete_column(u'main_character', 'initiative_total')

        # Deleting field 'Character.total_hp'
        db.delete_column(u'main_character', 'total_hp')

        # Deleting field 'Character.nonlethal_damage'
        db.delete_column(u'main_character', 'nonlethal_damage')
