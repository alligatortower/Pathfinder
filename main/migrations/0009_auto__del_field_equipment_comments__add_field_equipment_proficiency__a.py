...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Equipment.comments'
        db.delete_column(u'main_equipment', 'comments')

        # Adding field 'Equipment.proficiency'
        db.add_column(u'main_equipment', 'proficiency',
                      self.gf('django.db.models.fields.CharField')(default='Light', max_length=10),
                      keep_default=False)
        ...
        # Adding field 'Equipment.size'
        db.add_column(u'main_equipment', 'size',
        ...
        # Deleting field 'Weapon.special'
        db.delete_column(u'main_weapon', 'special')

        # Adding field 'Weapon.weapon_type'
        db.add_column(u'main_weapon', 'weapon_type',
                      self.gf('django.db.models.fields.CharField')(default='simple', max_length=20),
                      keep_default=False)

        # Adding field 'Weapon.reach'
        db.add_column(u'main_weapon', 'reach',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Weapon.range_increment'
        db.add_column(u'main_weapon', 'range_increment',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Weapon.quantity'
        db.add_column(u'main_weapon', 'quantity',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Equipment.comments'
        db.add_column(u'main_equipment', 'comments',
                      self.gf('django.db.models.fields.CharField')(default='---', max_length=500),
                      keep_default=False)

        # Deleting field 'Equipment.proficiency'
        db.delete_column(u'main_equipment', 'proficiency')

        # Deleting field 'Equipment.name'
        db.delete_column(u'main_equipment', 'name')

        # Deleting field 'Equipment.size'
        db.delete_column(u'main_equipment', 'size')
        ...
        # Adding field 'Weapon.special'
        db.add_column(u'main_weapon', 'special',
                      self.gf('django.db.models.fields.CharField')(default='what', max_length=10),
                      keep_default=False)

        # Deleting field 'Weapon.weapon_type'
        db.delete_column(u'main_weapon', 'weapon_type')

        # Deleting field 'Weapon.reach'
        db.delete_column(u'main_weapon', 'reach')

        # Deleting field 'Weapon.range_increment'
        db.delete_column(u'main_weapon', 'range_increment')

        # Deleting field 'Weapon.quantity'
        db.delete_column(u'main_weapon', 'quantity')
    ...
    models = {
        ...
        u'main.equipment': {
            ...
            'is_equiped': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
