...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.fortitude_save_base'
        db.add_column(u'main_character', 'fortitude_save_base',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.fortitude_save_temp'
        db.add_column(u'main_character', 'fortitude_save_temp',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.reflex_save_base'
        db.add_column(u'main_character', 'reflex_save_base',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.reflex_save_temp'
        db.add_column(u'main_character', 'reflex_save_temp',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.willpower_save_base'
        db.add_column(u'main_character', 'willpower_save_base',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.willpower_save_temp'
        db.add_column(u'main_character', 'willpower_save_temp',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.fortitude_save_base'
        db.delete_column(u'main_character', 'fortitude_save_base')

        # Deleting field 'Character.fortitude_save_temp'
        db.delete_column(u'main_character', 'fortitude_save_temp')

        # Deleting field 'Character.reflex_save_base'
        db.delete_column(u'main_character', 'reflex_save_base')

        # Deleting field 'Character.reflex_save_temp'
        db.delete_column(u'main_character', 'reflex_save_temp')

        # Deleting field 'Character.willpower_save_base'
        db.delete_column(u'main_character', 'willpower_save_base')

        # Deleting field 'Character.willpower_save_temp'
        db.delete_column(u'main_character', 'willpower_save_temp')
