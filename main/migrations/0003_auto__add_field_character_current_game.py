...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Character.current_game'
        db.add_column(u'main_character', 'current_game',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Game'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Character.current_game'
        db.delete_column(u'main_character', 'current_game_id')
