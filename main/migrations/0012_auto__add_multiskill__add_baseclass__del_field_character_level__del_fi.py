...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MultiSkill'
        db.create_table(u'main_multiskill', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('character', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Character'])),
            ('sk_craft_or_profession', self.gf('django.db.models.fields.CharField')(default='craft', max_length=10)),
            ('sk_domain', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('sk_total', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('sk_ranks', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('sk_misc', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('sk_class', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'main', ['MultiSkill'])

        # Adding model 'BaseClass'
        db.create_table(u'main_baseclass', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('class_name', self.gf('django.db.models.fields.CharField')(default='Barbarian', max_length=30)),
            ('class_levels', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=30)),
        ))
        db.send_create_signal(u'main', ['BaseClass'])

        # Deleting field 'Character.level'
        db.delete_column(u'main_character', 'level')
        ...
        # Deleting field 'Character.base_class_1'
        db.delete_column(u'main_character', 'base_class_1')
        ...
        # Adding field 'Character.size_mod'
        db.add_column(u'main_character', 'size_mod',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.hd'
        db.add_column(u'main_character', 'hd',
                      self.gf('django.db.models.fields.CharField')(default='1d6', max_length=10),
                      keep_default=False)

        # Adding field 'Character.total_levels'
        db.add_column(u'main_character', 'total_levels',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.total_ranks'
        db.add_column(u'main_character', 'total_ranks',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.max_ranks'
        db.add_column(u'main_character', 'max_ranks',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MultiSkill'
        db.delete_table(u'main_multiskill')

        # Deleting model 'BaseClass'
        db.delete_table(u'main_baseclass')

        # Adding field 'Character.level'
        db.add_column(u'main_character', 'level',
        ...
        # Adding field 'Character.base_class_1'
        db.add_column(u'main_character', 'base_class_1',
        ...
        # Deleting field 'Character.size_mod'
        db.delete_column(u'main_character', 'size_mod')

        # Deleting field 'Character.hd'
        db.delete_column(u'main_character', 'hd')

        # Deleting field 'Character.total_levels'
        db.delete_column(u'main_character', 'total_levels')

        # Deleting field 'Character.total_ranks'
        db.delete_column(u'main_character', 'total_ranks')

        # Deleting field 'Character.max_ranks'
        db.delete_column(u'main_character', 'max_ranks')
