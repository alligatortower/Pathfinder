...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'BaseClass', fields ['class_belongs_to', 'class_name']
        db.create_unique(u'main_baseclass', ['class_belongs_to_id', 'class_name'])

        # Adding field 'Character.ability_str_equip'
        db.add_column(u'main_character', 'ability_str_equip',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_str_spell'
        db.add_column(u'main_character', 'ability_str_spell',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_str_misc'
        db.add_column(u'main_character', 'ability_str_misc',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_str_misc_total'
        db.add_column(u'main_character', 'ability_str_misc_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_dex_equip'
        db.add_column(u'main_character', 'ability_dex_equip',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_dex_spell'
        db.add_column(u'main_character', 'ability_dex_spell',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_dex_misc'
        db.add_column(u'main_character', 'ability_dex_misc',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_dex_misc_total'
        db.add_column(u'main_character', 'ability_dex_misc_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_con_equip'
        db.add_column(u'main_character', 'ability_con_equip',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_con_spell'
        db.add_column(u'main_character', 'ability_con_spell',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_con_misc'
        db.add_column(u'main_character', 'ability_con_misc',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_con_misc_total'
        db.add_column(u'main_character', 'ability_con_misc_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_wis_equip'
        db.add_column(u'main_character', 'ability_wis_equip',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_wis_spell'
        db.add_column(u'main_character', 'ability_wis_spell',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_wis_misc'
        db.add_column(u'main_character', 'ability_wis_misc',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_wis_misc_total'
        db.add_column(u'main_character', 'ability_wis_misc_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_int_equip'
        db.add_column(u'main_character', 'ability_int_equip',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_int_spell'
        db.add_column(u'main_character', 'ability_int_spell',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_int_misc'
        db.add_column(u'main_character', 'ability_int_misc',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_int_misc_total'
        db.add_column(u'main_character', 'ability_int_misc_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_cha_equip'
        db.add_column(u'main_character', 'ability_cha_equip',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_cha_spell'
        db.add_column(u'main_character', 'ability_cha_spell',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_cha_misc'
        db.add_column(u'main_character', 'ability_cha_misc',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_cha_misc_total'
        db.add_column(u'main_character', 'ability_cha_misc_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'BaseClass', fields ['class_belongs_to', 'class_name']
        db.delete_unique(u'main_baseclass', ['class_belongs_to_id', 'class_name'])

        # Deleting field 'Character.ability_str_equip'
        db.delete_column(u'main_character', 'ability_str_equip')

        # Deleting field 'Character.ability_str_spell'
        db.delete_column(u'main_character', 'ability_str_spell')

        # Deleting field 'Character.ability_str_misc'
        db.delete_column(u'main_character', 'ability_str_misc')

        # Deleting field 'Character.ability_str_misc_total'
        db.delete_column(u'main_character', 'ability_str_misc_total')

        # Deleting field 'Character.ability_dex_equip'
        db.delete_column(u'main_character', 'ability_dex_equip')

        # Deleting field 'Character.ability_dex_spell'
        db.delete_column(u'main_character', 'ability_dex_spell')

        # Deleting field 'Character.ability_dex_misc'
        db.delete_column(u'main_character', 'ability_dex_misc')

        # Deleting field 'Character.ability_dex_misc_total'
        db.delete_column(u'main_character', 'ability_dex_misc_total')

        # Deleting field 'Character.ability_con_equip'
        db.delete_column(u'main_character', 'ability_con_equip')

        # Deleting field 'Character.ability_con_spell'
        db.delete_column(u'main_character', 'ability_con_spell')

        # Deleting field 'Character.ability_con_misc'
        db.delete_column(u'main_character', 'ability_con_misc')

        # Deleting field 'Character.ability_con_misc_total'
        db.delete_column(u'main_character', 'ability_con_misc_total')

        # Deleting field 'Character.ability_wis_equip'
        db.delete_column(u'main_character', 'ability_wis_equip')

        # Deleting field 'Character.ability_wis_spell'
        db.delete_column(u'main_character', 'ability_wis_spell')

        # Deleting field 'Character.ability_wis_misc'
        db.delete_column(u'main_character', 'ability_wis_misc')

        # Deleting field 'Character.ability_wis_misc_total'
        db.delete_column(u'main_character', 'ability_wis_misc_total')

        # Deleting field 'Character.ability_int_equip'
        db.delete_column(u'main_character', 'ability_int_equip')

        # Deleting field 'Character.ability_int_spell'
        db.delete_column(u'main_character', 'ability_int_spell')

        # Deleting field 'Character.ability_int_misc'
        db.delete_column(u'main_character', 'ability_int_misc')

        # Deleting field 'Character.ability_int_misc_total'
        db.delete_column(u'main_character', 'ability_int_misc_total')

        # Deleting field 'Character.ability_cha_equip'
        db.delete_column(u'main_character', 'ability_cha_equip')

        # Deleting field 'Character.ability_cha_spell'
        db.delete_column(u'main_character', 'ability_cha_spell')

        # Deleting field 'Character.ability_cha_misc'
        db.delete_column(u'main_character', 'ability_cha_misc')

        # Deleting field 'Character.ability_cha_misc_total'
        db.delete_column(u'main_character', 'ability_cha_misc_total')
    ...
    models = {
        ...
        u'main.baseclass': {
            'Meta': {'unique_together': "(('class_belongs_to', 'class_name'),)", 'object_name': 'BaseClass'},
        ...
        u'main.character': {
            ...
            'ability_cha_equip': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'ability_cha_misc': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'ability_cha_misc_total': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'ability_cha_spell': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'ability_con_equip': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'ability_con_misc': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'ability_con_misc_total': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'ability_con_spell': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'ability_dex_equip': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'ability_dex_misc': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'ability_dex_misc_total': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'ability_dex_spell': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'ability_int_equip': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'ability_int_misc': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'ability_int_misc_total': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'ability_int_spell': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'ability_str_equip': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'ability_str_misc': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'ability_str_misc_total': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'ability_str_spell': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'ability_wis_equip': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'ability_wis_misc': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'ability_wis_misc_total': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'ability_wis_spell': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
