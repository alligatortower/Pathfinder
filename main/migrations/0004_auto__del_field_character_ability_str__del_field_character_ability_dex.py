...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Character.ability_str'
        db.delete_column(u'main_character', 'ability_str')

        # Deleting field 'Character.ability_dex'
        db.delete_column(u'main_character', 'ability_dex')

        # Deleting field 'Character.ability_cha'
        db.delete_column(u'main_character', 'ability_cha')

        # Deleting field 'Character.ability_con'
        db.delete_column(u'main_character', 'ability_con')

        # Deleting field 'Character.ability_wis'
        db.delete_column(u'main_character', 'ability_wis')

        # Deleting field 'Character.ability_int'
        db.delete_column(u'main_character', 'ability_int')

        # Adding field 'Character.ability_str_base'
        db.add_column(u'main_character', 'ability_str_base',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_str_score'
        db.add_column(u'main_character', 'ability_str_score',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_dex_base'
        db.add_column(u'main_character', 'ability_dex_base',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_column='ability_dex'),
                      keep_default=False)

        # Adding field 'Character.ability_dex_score'
        db.add_column(u'main_character', 'ability_dex_score',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_con_base'
        db.add_column(u'main_character', 'ability_con_base',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_con_score'
        db.add_column(u'main_character', 'ability_con_score',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_wis_base'
        db.add_column(u'main_character', 'ability_wis_base',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_wis_score'
        db.add_column(u'main_character', 'ability_wis_score',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_int_base'
        db.add_column(u'main_character', 'ability_int_base',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_int_score'
        db.add_column(u'main_character', 'ability_int_score',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_cha_base'
        db.add_column(u'main_character', 'ability_cha_base',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_cha_score'
        db.add_column(u'main_character', 'ability_cha_score',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Character.ability_dex_temp'
        db.alter_column(u'main_character', 'ability_dex_temp', self.gf('django.db.models.fields.PositiveIntegerField')())
        ...
        # Changing field 'Character.ability_str_temp'
        db.alter_column(u'main_character', 'ability_str_temp', self.gf('django.db.models.fields.PositiveIntegerField')())
        ...
        # Changing field 'Character.ability_int_temp'
        db.alter_column(u'main_character', 'ability_int_temp', self.gf('django.db.models.fields.PositiveIntegerField')())
        ...
        # Changing field 'Character.ability_wis_temp'
        db.alter_column(u'main_character', 'ability_wis_temp', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Character.ability_con_temp'
        db.alter_column(u'main_character', 'ability_con_temp', self.gf('django.db.models.fields.PositiveIntegerField')())
        ...
        # Changing field 'Character.ability_cha_temp'
        db.alter_column(u'main_character', 'ability_cha_temp', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):
        # Adding field 'Character.ability_str'
        db.add_column(u'main_character', 'ability_str',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_dex'
        db.add_column(u'main_character', 'ability_dex',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_column='ability_dex'),
                      keep_default=False)

        # Adding field 'Character.ability_cha'
        db.add_column(u'main_character', 'ability_cha',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_con'
        db.add_column(u'main_character', 'ability_con',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_wis'
        db.add_column(u'main_character', 'ability_wis',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ability_int'
        db.add_column(u'main_character', 'ability_int',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Character.ability_str_base'
        db.delete_column(u'main_character', 'ability_str_base')

        # Deleting field 'Character.ability_str_score'
        db.delete_column(u'main_character', 'ability_str_score')

        # Deleting field 'Character.ability_dex_base'
        db.delete_column(u'main_character', 'ability_dex')

        # Deleting field 'Character.ability_dex_score'
        db.delete_column(u'main_character', 'ability_dex_score')

        # Deleting field 'Character.ability_con_base'
        db.delete_column(u'main_character', 'ability_con_base')

        # Deleting field 'Character.ability_con_score'
        db.delete_column(u'main_character', 'ability_con_score')

        # Deleting field 'Character.ability_wis_base'
        db.delete_column(u'main_character', 'ability_wis_base')

        # Deleting field 'Character.ability_wis_score'
        db.delete_column(u'main_character', 'ability_wis_score')

        # Deleting field 'Character.ability_int_base'
        db.delete_column(u'main_character', 'ability_int_base')

        # Deleting field 'Character.ability_int_score'
        db.delete_column(u'main_character', 'ability_int_score')

        # Deleting field 'Character.ability_cha_base'
        db.delete_column(u'main_character', 'ability_cha_base')

        # Deleting field 'Character.ability_cha_score'
        db.delete_column(u'main_character', 'ability_cha_score')


        # Changing field 'Character.ability_dex_temp'
        db.alter_column(u'main_character', 'ability_dex_temp', self.gf('django.db.models.fields.IntegerField')())
        ...
        # Changing field 'Character.ability_str_temp'
        db.alter_column(u'main_character', 'ability_str_temp', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.ability_wis_mod'
        db.alter_column(u'main_character', 'ability_wis_mod', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.ability_int_temp'
        db.alter_column(u'main_character', 'ability_int_temp', self.gf('django.db.models.fields.IntegerField')())
        ...
        # Changing field 'Character.ability_wis_temp'
        db.alter_column(u'main_character', 'ability_wis_temp', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.ability_con_temp'
        db.alter_column(u'main_character', 'ability_con_temp', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.ability_str_mod'
        db.alter_column(u'main_character', 'ability_str_mod', self.gf('django.db.models.fields.IntegerField')(db_column='ability_str_mod'))

        # Changing field 'Character.ability_cha_temp'
        db.alter_column(u'main_character', 'ability_cha_temp', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'main.character': {
            ...
            'ability_cha_mod': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            ...
            'ability_con_mod': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            ...
            'ability_dex_mod': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'db_column': "'ability_dex_mod'"}),
            ...
            'ability_int_mod': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            ...
            'ability_str_mod': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'db_column': "'ability_str_mod'"}),
            ...
            'ability_wis_mod': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
