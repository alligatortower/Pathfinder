...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Character.ability_dex'
        db.alter_column(u'main_character', 'ability_dex', self.gf('django.db.models.fields.IntegerField')(db_column='ability_dex'))

        # Changing field 'Character.sk_acrobatics'
        db.alter_column(u'main_character', 'sk_acrobatics', self.gf('django.db.models.fields.IntegerField')(db_column='sk_acrobatics'))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Character.ability_dex'
        db.alter_column(u'main_character', 'ability_dex', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.sk_acrobatics'
        db.alter_column(u'main_character', 'sk_acrobatics', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.ability_dex_mod'
        db.alter_column(u'main_character', 'ability_dex_mod', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Character.ability_str_mod'
        db.alter_column(u'main_character', 'ability_str_mod', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'main.character': {
            ...
            'ability_dex': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_column': "'ability_dex'"}),
