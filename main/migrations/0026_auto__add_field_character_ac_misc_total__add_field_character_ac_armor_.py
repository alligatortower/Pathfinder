...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.ac_misc_total'
        db.add_column(u'main_character', 'ac_misc_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.ac_armor_total'
        db.add_column(u'main_character', 'ac_armor_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.ac_misc_total'
        db.delete_column(u'main_character', 'ac_misc_total')

        # Deleting field 'Character.ac_armor_total'
        db.delete_column(u'main_character', 'ac_armor_total')
