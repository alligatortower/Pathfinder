...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Character.melee_attack_bonus_temp'
        db.delete_column(u'main_character', 'melee_attack_bonus_temp')

        # Deleting field 'Character.bab'
        db.delete_column(u'main_character', 'bab')

        # Deleting field 'Character.range_attack_bonus_temp'
        db.delete_column(u'main_character', 'range_attack_bonus_temp')

        # Deleting field 'Character.bab_str_or_dex'
        db.delete_column(u'main_character', 'bab_str_or_dex')

        # Deleting field 'Character.bab_temp'
        db.delete_column(u'main_character', 'bab_temp')

        # Adding field 'Character.base_attack_bonus_1'
        db.add_column(u'main_character', 'base_attack_bonus_1',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.base_attack_bonus_2'
        db.add_column(u'main_character', 'base_attack_bonus_2',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.base_attack_bonus_3'
        db.add_column(u'main_character', 'base_attack_bonus_3',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.base_attack_bonus_4'
        db.add_column(u'main_character', 'base_attack_bonus_4',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.base_attack_bonus_misc'
        db.add_column(u'main_character', 'base_attack_bonus_misc',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Character.melee_attack_bonus_temp'
        db.add_column(u'main_character', 'melee_attack_bonus_temp',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
        ...
        # Adding field 'Character.range_attack_bonus_temp'
        db.add_column(u'main_character', 'range_attack_bonus_temp',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.bab_str_or_dex'
        db.add_column(u'main_character', 'bab_str_or_dex',
                      self.gf('django.db.models.fields.CharField')(default='str', max_length=3),
                      keep_default=False)

        # Adding field 'Character.bab_temp'
        db.add_column(u'main_character', 'bab_temp',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Character.base_attack_bonus_1'
        db.delete_column(u'main_character', 'base_attack_bonus_1')

        # Deleting field 'Character.base_attack_bonus_2'
        db.delete_column(u'main_character', 'base_attack_bonus_2')

        # Deleting field 'Character.base_attack_bonus_3'
        db.delete_column(u'main_character', 'base_attack_bonus_3')

        # Deleting field 'Character.base_attack_bonus_4'
        db.delete_column(u'main_character', 'base_attack_bonus_4')

        # Deleting field 'Character.base_attack_bonus_misc'
        db.delete_column(u'main_character', 'base_attack_bonus_misc')
    ...
    models = {
        ...
        u'main.character': {
            ...
            'melee_attack_bonus': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'range_attack_bonus': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
