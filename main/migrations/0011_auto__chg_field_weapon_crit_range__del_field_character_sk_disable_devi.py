...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Weapon.crit_range'
        db.alter_column(u'main_weapon', 'crit_range', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
        # Deleting field 'Character.sk_disable_devie'
        db.delete_column(u'main_character', 'sk_disable_devie')

        # Adding field 'Character.sk_disable_device'
        db.add_column(u'main_character', 'sk_disable_device',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Weapon.crit_range'
        db.alter_column(u'main_weapon', 'crit_range', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))
        # Adding field 'Character.sk_disable_devie'
        db.add_column(u'main_character', 'sk_disable_devie',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Character.sk_disable_device'
        db.delete_column(u'main_character', 'sk_disable_device')
