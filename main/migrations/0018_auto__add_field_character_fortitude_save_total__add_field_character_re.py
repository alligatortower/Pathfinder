...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.fortitude_save_total'
        db.add_column(u'main_character', 'fortitude_save_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.reflex_save_total'
        db.add_column(u'main_character', 'reflex_save_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.willpower_save_total'
        db.add_column(u'main_character', 'willpower_save_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.fortitude_save_total'
        db.delete_column(u'main_character', 'fortitude_save_total')

        # Deleting field 'Character.reflex_save_total'
        db.delete_column(u'main_character', 'reflex_save_total')

        # Deleting field 'Character.willpower_save_total'
        db.delete_column(u'main_character', 'willpower_save_total')
