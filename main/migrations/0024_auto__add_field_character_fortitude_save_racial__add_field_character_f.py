...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.fortitude_save_racial'
        db.add_column(u'main_character', 'fortitude_save_racial',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.fortitude_save_equip'
        db.add_column(u'main_character', 'fortitude_save_equip',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.fortitude_save_feat'
        db.add_column(u'main_character', 'fortitude_save_feat',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.fortitude_save_misc'
        db.add_column(u'main_character', 'fortitude_save_misc',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.fortitude_save_misc_total'
        db.add_column(u'main_character', 'fortitude_save_misc_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.reflex_save_racial'
        db.add_column(u'main_character', 'reflex_save_racial',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.reflex_save_equip'
        db.add_column(u'main_character', 'reflex_save_equip',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.reflex_save_feat'
        db.add_column(u'main_character', 'reflex_save_feat',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.reflex_save_misc'
        db.add_column(u'main_character', 'reflex_save_misc',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.reflex_save_misc_total'
        db.add_column(u'main_character', 'reflex_save_misc_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.willpower_save_racial'
        db.add_column(u'main_character', 'willpower_save_racial',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.willpower_save_equip'
        db.add_column(u'main_character', 'willpower_save_equip',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.willpower_save_feat'
        db.add_column(u'main_character', 'willpower_save_feat',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.willpower_save_misc'
        db.add_column(u'main_character', 'willpower_save_misc',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Character.willpower_save_misc_total'
        db.add_column(u'main_character', 'willpower_save_misc_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.fortitude_save_racial'
        db.delete_column(u'main_character', 'fortitude_save_racial')

        # Deleting field 'Character.fortitude_save_equip'
        db.delete_column(u'main_character', 'fortitude_save_equip')

        # Deleting field 'Character.fortitude_save_feat'
        db.delete_column(u'main_character', 'fortitude_save_feat')

        # Deleting field 'Character.fortitude_save_misc'
        db.delete_column(u'main_character', 'fortitude_save_misc')

        # Deleting field 'Character.fortitude_save_misc_total'
        db.delete_column(u'main_character', 'fortitude_save_misc_total')

        # Deleting field 'Character.reflex_save_racial'
        db.delete_column(u'main_character', 'reflex_save_racial')

        # Deleting field 'Character.reflex_save_equip'
        db.delete_column(u'main_character', 'reflex_save_equip')

        # Deleting field 'Character.reflex_save_feat'
        db.delete_column(u'main_character', 'reflex_save_feat')

        # Deleting field 'Character.reflex_save_misc'
        db.delete_column(u'main_character', 'reflex_save_misc')

        # Deleting field 'Character.reflex_save_misc_total'
        db.delete_column(u'main_character', 'reflex_save_misc_total')

        # Deleting field 'Character.willpower_save_racial'
        db.delete_column(u'main_character', 'willpower_save_racial')

        # Deleting field 'Character.willpower_save_equip'
        db.delete_column(u'main_character', 'willpower_save_equip')

        # Deleting field 'Character.willpower_save_feat'
        db.delete_column(u'main_character', 'willpower_save_feat')

        # Deleting field 'Character.willpower_save_misc'
        db.delete_column(u'main_character', 'willpower_save_misc')

        # Deleting field 'Character.willpower_save_misc_total'
        db.delete_column(u'main_character', 'willpower_save_misc_total')
